...
/**
 * <p>Java class for tActivityOrCompensateContainer complex type.
 * 
...
@XmlType(name = "tActivityOrCompensateContainer", propOrder = {
    "empty",
    "invoke",
    "receive",
    "reply",
...
@XmlSeeAlso({
    TCompensationHandler.class,
    TCatch.class
})
public class TActivityOrCompensateContainer
